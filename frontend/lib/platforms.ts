...
export const PLATFORM_DEFS: PlatformDef[] = [
  ...
  { id: "linkedin", label: "LinkedIn", icon: "li", url_template: "https://linkedin.com/in/{handle}", handle_placeholder: "public profile id", real_api: false },
  ...
  { id: "kaggle", label: "Kaggle", icon: "kg", url_template: "https://kaggle.com/{handle}", handle_placeholder: "username", real_api: false },
  ...
  { id: "medium", label: "Medium", icon: "md", url_template: "https://medium.com/@{handle}", handle_placeholder: "@username", real_api: false },
  { id: "hashnode", label: "Hashnode", icon: "hn", url_template: "https://hashnode.com/@{handle}", handle_placeholder: "@username", real_api: false },
  { id: "devto", label: "DEV Community", icon: "dv", url_template: "https://dev.to/{handle}", handle_placeholder: "username", real_api: false },
  { id: "twitter", label: "X (Twitter)", icon: "tw", url_template: "https://x.com/{handle}", handle_placeholder: "@username", real_api: false },
];

export const PLATFORM_CATEGORIES: Array<{ name: string; ids: string[] }> = [
  { name: "Code Hosting", ids: ["github", "gitlab", "bitbucket"] },
  { name: "Professional & Social", ids: ["linkedin", "portfolio", "twitter", "medium", "hashnode", "devto"] },
  { name: "Coding & Competitions", ids: ["leetcode", "interviewbit", "codeforces", "codechef", "geeksforgeeks", "hackerrank", "kaggle", "stackoverflow"] },
